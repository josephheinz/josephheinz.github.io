...
class Icon extends HTMLElement {
  ...
  render() {
    this.calcPos(),
      (this.shadow.innerHTML = `<style>:host{display: flex;align-items: center;justify-content: center;position: absolute;top: ${
        this.top
      }px;left: ${
        this.left
        ...
        this.name ? this.name : ""
      }';        position: absolute;    top: 76px;        font-size: 0.5em;        line-height: 1em;      }</style><slot></slot>`);
  }
}
...
class Window extends HTMLElement {
  ...
  render() {
    ...
    (winTitle.id = "winTitle"), (winTitle.innerText = this.title), (winTitle.classList.add("title-bar"));
    const buttons = document.createElement("div");
    (buttons.id = "buttons"), (buttons.classList.add("e"));
